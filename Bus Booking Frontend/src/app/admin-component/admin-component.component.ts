...
export class AdminComponentComponent implements OnInit {
  ...
  dateOfJourney: Date;
  areSourceAndDestinationSame(): boolean {
    return this.addBus.source && this.addBus.destination && this.addBus.source.toLowerCase() === this.addBus.destination.toLowerCase();
}
